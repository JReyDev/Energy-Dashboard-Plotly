...
#Crude Oil total
cl_total_data = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. CL Stock Ending Total Weekly.csv', parse_dates=['Date'],index_col=['Date'])

#Cl Commercial Total
cl_comm_total = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. CL Stock Ending Commercial excl. SPR Wkly.csv', parse_dates=['Date'], index_col=['Date'])

#CL SPR Total
cl_spr = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. CL Stock Ending incl. SPR Weekly.csv', parse_dates=['Date'],index_col=['Date'])


##Other Stock
#Total Motor Gasoline
motor_gas_total = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Ending Total Gasoline Weekly.csv',parse_dates=['Date'], index_col = ['Date'])

#Kerosene Type Jet Fuel
kerosene_jet_fuel = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Ending Total Kerosene Type Jet Fuel Weekly.csv',parse_dates=['Date'], index_col = ['Date'])

#Distillate Fuel Oil
distillate_fuel_oil = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Distillate Fuel Oil Stock Ending Weekly.csv',parse_dates=['Date'], index_col = ['Date'])
...
#Domestic Production
us_dom_prod = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Domestic CL Production Weekly.csv',parse_dates=['Date'], index_col = ['Date'])

#Alaska Production
alaska_prod =  pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Alaska Production.csv',parse_dates = ['Date'], index_col = ['Date'])

#Lower 48 Production
lower_48_prod = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Lower 48 Field Production.csv',parse_dates = ['Date'], index_col = ['Date'])

#CL Input To Refineries
cl_input = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Refiner Net Input of CL.csv',parse_dates = ['Date'], index_col = ['Date'])



#CL Net Imports
cl_net_imports = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Net Imports incl. SPR CL Weekly.csv', parse_dates = ['Date'],index_col= ['Date'])

#CL Imports
cl_imports = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. Commercial CL Imports excl. SPR.csv', parse_dates=['Date'],index_col=['Date'])

#CL Exports
cl_exports = pd.read_csv('Z:\\Python Projects\CrudeOil data\\EIA Data\\U.S. CL ExportsWeekly.csv', parse_dates=['Date'],index_col=['Date'])

#Working Storage
wstorage_df = pd.read_csv('Z:\\Python Projects\\CrudeOil data\\EIA Data\\EIA Crude Oil Working Storage.csv', parse_dates=['Date'])
